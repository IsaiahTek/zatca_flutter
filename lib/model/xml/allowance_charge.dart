...
class AllowanceCharge {
  ...
  AllowanceCharge({required this.reason, required this.amount, required this.tax});
  ...
  toXml(XmlBuilder builder){
    builder.element('cac:AllowanceCharge', nest: (){
        ...
        builder.element('cac:TaxCategory', nest: (){
          builder.element('cbc:ID', attributes: {'schemeID': 'UN/ECE 5305', 'schemeAgencyID': '6'}, nest: taxCategoryCodeValues[tax.code??TaxCategoryCode.standard]);
          builder.element('cbc:Percent', nest: tax.percent);
          builder.element('cac:TaxScheme', nest: (){
            builder.element('cbc:ID', attributes: {'schemeID': 'UN/ECE 5153', 'schemeAgencyID': '6'}, nest: tax.taxSchemeCode?.name.toUpperCase()??TaxSchemeCode.vat.name.toUpperCase());
          });
        });
      });
  }
